    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.CharField(max_length=50, primary_key=True, serialize=False, unique=True, verbose_name='Documento')),
                ('birth', models.DateField(verbose_name='Fecha de nacimiento (YYYY-MM-DD)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.CharField(db_index=True, max_length=50, verbose_name='Documento')),
                ('birth', models.DateField(verbose_name='Fecha de nacimiento (YYYY-MM-DD)')),
                ('phone', models.CharField(db_index=True, max_length=50, verbose_name='Celular')),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
